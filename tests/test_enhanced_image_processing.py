...
def create_test_image_grayscale(width=100, height=100):
...
def create_test_image_rgb(width=100, height=100):
...
class TestRotateImagePrecise:
    ...
    def test_rotate_45_degrees_expand(self):
        ...
        img = create_test_image_grayscale(100, 100)
    ...
    def test_rotate_with_fillcolor_rgb(self):
        ...
        img = create_test_image_rgb(50, 50)
